          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                We are dedicated to providing Australians with a safe, reliable, and exciting way to participate in Oz
                Lotto. Our platform connects lottery enthusiasts with their dreams while maintaining the highest
          ...
          <div className="bg-gradient-to-r from-yellow-100 to-orange-100 rounded-3xl p-12">
            ...
            <div className="max-w-4xl mx-auto text-lg text-gray-700 space-y-6">
              <p>
                ...
                wanted to create a platform that makes participating in Oz Lotto easier, safer, and more enjoyable.
              </p>
              <p>
              ...
              <p>
                Since our launch, we've helped thousands of Australians participate in Oz Lotto draws, and we're proud
